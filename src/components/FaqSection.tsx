...
const FAQS: Faq[] = [
  {
    ...
    a: "tekno.works is a research platform for private-market and tokenized companies. We combine on-chain data, treasury analysis, holder intelligence, development activity, governance, and AI insights into one institutional-grade workspace.",
  },
  {
  ...
  {
    q: "Is tekno.works an investment platform?",
    a: "No. tekno.works provides research and analytics. We do not provide financial advice or guarantee investment outcomes. Our goal is to make private-market intelligence transparent and accessible.",
  },
];
